<?php
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  $url2 = $api->url_facet(2);
  $parsed_json2 = parse($url2);
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  $url3 = $api->url_facet(3);
    ...
    <ul class="list">
          <li><i class="fas fa-search"></i> Liste des résultats</li>
              ...
              <?php
                ...
                $url2 = "https://data.enseignementsup-recherche.gouv.fr/api/records/1.0/search/?dataset=fr-esr-principaux-etablissements-enseignement-superieur&rows=60&sort=uo_lib&refine.type_d_etablissement=Universit%C3%A9&apikey=e0b79b2bc585516ae85be6e4f041239153ea9aaf98c61724e6bc364e";
                $parsed_json = parse($urlForm);
                $parsed_json2 = parse($url2);
                echo "<p>".count($parsed_json["records"]). " resultat(s) </p>";
                $array = create_accordian($parsed_json,$parsed_json2);
                $coor = array_unique($array[0],SORT_REGULAR);
                $univ = array_unique($array[1],SORT_REGULAR);
                $url = array_unique($array[2],SORT_REGULAR);
                create_popup($coor,$univ,$url);
              ?>
    </ul>
    <!--/////////////////////////////////////////////////////////////////////////-->
